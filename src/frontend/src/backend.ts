...
export class Backend implements backendInterface {
    ...
    async addMedia(arg0: MediaType, arg1: string): Promise<FeedItem> {
        if (this.processError) {
            try {
                const result = await this.actor.addMedia(await to_candid_MediaType_n8(this._uploadFile, this._downloadFile, arg0), arg1);
                return from_candid_FeedItem_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
async function from_candid_FeedItem_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FeedItem): Promise<FeedItem> {
    return await from_candid_record_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_MediaType_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaType): Promise<MediaType> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        media: await from_candid_MediaType_n13(_uploadFile, _downloadFile, value.media),
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FeedItem>): Promise<Array<FeedItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FeedItem_n11(_uploadFile, _downloadFile, x)));
}
